...
const catalogApi = {
  ...
  getManageTours: (params) =>
    axiosClient.get("/products/admin/manage", { params }),
  ...
  getManageLocations: (params) =>
    axiosClient.get("/locations/manage", { params }), // Đã thêm ở bước trước
  ...
  getManageCategories: (params) =>
    axiosClient.get("/categories/manage", { params }), // Đã thêm ở bước trước
  requestCategory: (payload) =>
    axiosClient.post("/categories/request", payload),
